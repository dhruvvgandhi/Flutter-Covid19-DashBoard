...
import 'package:covid19/models/Districts.dart';
    ...
    return new Scaffold(
      appBar: new AppBar(
        title: new Text(widget.title,
          style: kTextStyleAppBar, textAlign: TextAlign.justify,),
      ),
      body: Container(
                            ...
                            ListTile(
                              ...
                              trailing: SingleChildScrollView(
                                child: Column(children: <Widget>[
                                  Text(
                                    " Active :${(snapshot.data[l[index]]['active'].toString())}",style: kDataActive,),
                                  Text(
                                    " Deaths :${(snapshot.data[l[index]]['deceased'].toString())}",style: kDataDeath,),
                                  Text(
                                    "Recovered :${(snapshot.data[l[index]]['recovered'].toString())}",style: kDataRecoverd,),
                                ]),
                              ),
                              isThreeLine: true,
                            )
